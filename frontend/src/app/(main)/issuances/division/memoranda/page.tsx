...
export default async function DivisionMemoranda() {
  const result = await getIssuancesAction("DIVISION", "DIVISION MEMORANDA");
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 w-full space-y-12 mt-12">
           ...
           <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter leading-none">
                 DIVISION <span className="text-blue-400 underline decoration-blue-500/30 underline-offset-8">MEMORANDA</span>
              </h1>
              <p className="text-slate-400 text-sm md:text-lg font-medium max-w-2xl">
                 Official internal circulars and administrative communications issued by the Office of the Schools Division Superintendent.
              </p>
            </div>
         </div>
      </section>
