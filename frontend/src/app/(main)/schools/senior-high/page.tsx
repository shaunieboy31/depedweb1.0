  ...
  return (
    <div className="w-full bg-[#f8fafc] min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900 pb-32">
      ...
      <SchoolHero 
        title="SENIOR HIGH"
        category="SCHOOL"
        subtitle="Specialized Education"
        description="Equipping Grades 11–12 learners with specialized skills for higher education, entrepreneurship, or employment."
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 -mt-12 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
             <ProgramSpotlight 
                title="SHS Specialized Tracks"
                subtitle="Career Readiness"
                description="Our Senior High Schools offer diverse strands designed for global competitiveness:"
                tracks={[
